---
polity_code: JPN-TOYAMA-1871-2025
polity_name: Toyama (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
# Toyama (prefecture of Japan)

## Summary

Toyama, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-TOYAMA` — **2,334 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.43_1` (Toyama). GADM 4.1 admin-1
...
**Territory description.** Toyama covers roughly **4,270 km2**, centred near
36.63°N 137.27°E, which places it on a modern map of Japan. For scale, that is
