---
polity_code: JPN-WAKAYAMA-1871-2025
polity_name: Wakayama (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
# Wakayama (prefecture of Japan)

## Summary

Wakayama, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-WAKAYAMA` — **2,216 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.44_1` (Wakayama). GADM 4.1 admin-1
...
**Territory description.** Wakayama covers roughly **4,651 km2**, centred near
33.91°N 135.35°E, which places it on a modern map of Japan. For scale, that is
about 1.2% of Japan's land area, and the figure is a **measurement of
