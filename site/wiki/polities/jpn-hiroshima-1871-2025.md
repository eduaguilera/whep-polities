---
polity_code: JPN-HIROSHIMA-1871-2025
polity_name: Hiroshima (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
# Hiroshima (prefecture of Japan)

## Summary

Hiroshima, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-HIROSHIMA` — **2,413 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.11_1` (Hiroshima). GADM 4.1 admin-1
...
**Territory description.** Hiroshima covers roughly **8,430 km2**, centred near
34.58°N 132.77°E, which places it on a modern map of Japan. For scale, that is
about 2.2% of Japan's land area, and the figure is a **measurement of
