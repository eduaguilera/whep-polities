---
polity_code: JPN-OITA-1871-2025
polity_name: Oita (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
# Oita (prefecture of Japan)

## Summary

Oita, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-OITA` — **2,399 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.30_1` (Oita). GADM 4.1 admin-1
...
**Territory description.** Oita covers roughly **6,344 km2**, centred near
33.21°N 131.35°E, which places it on a modern map of Japan. For scale, that is
