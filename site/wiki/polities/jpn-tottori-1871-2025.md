---
polity_code: JPN-TOTTORI-1871-2025
polity_name: Tottori (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
# Tottori (prefecture of Japan)

## Summary

Tottori, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-TOTTORI` — **2,380 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.42_1` (Tottori). GADM 4.1 admin-1
...
**Territory description.** Tottori covers roughly **3,479 km2**, centred near
35.33°N 134.26°E, which places it on a modern map of Japan. For scale, that is
about 0.9% of Japan's land area, and the figure is a **measurement of
