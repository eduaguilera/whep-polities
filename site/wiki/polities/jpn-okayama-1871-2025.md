---
polity_code: JPN-OKAYAMA-1871-2025
polity_name: Okayama (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
# Okayama (prefecture of Japan)

## Summary

Okayama, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-OKAYAMA` — **2,413 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.31_1` (Okayama). GADM 4.1 admin-1
...
**Territory description.** Okayama covers roughly **7,260 km2**, centred near
34.89°N 133.79°E, which places it on a modern map of Japan. For scale, that is
about 1.9% of Japan's land area, and the figure is a **measurement of
