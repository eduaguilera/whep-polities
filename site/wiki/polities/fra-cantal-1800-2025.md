...
container:
  ...
  - code: FRA-1860-1871
    start_year: 1860
    end_year: 1871
    basis: Cantal was French before and after the Treaty of Turin (24 March 1860); the annexation of Savoy and Nice enlarged France without touching it, so it sits in FRA-1860-1871, the national row from 1860 to the 1871 loss of Alsace-Lorraine.
  - code: FRA-1871-1919
    start_year: 1871
    end_year: 1919
...
**RESOLVED 2026-09-24.** The polygon this question was waiting for is attached: `gadm-4.1-adm2` feature `FRA.1.4_1` was bound on 2026-09-09 in commit 433a81a, and the shipped geometry measures 5,786 km² in `data/final/polities_database.gpkg` (ESRI:54034 equal-area). The text above is kept as the record of what blocked it.
