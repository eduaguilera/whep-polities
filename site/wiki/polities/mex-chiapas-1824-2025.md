...
**Polygon status:** `assigned` — `gadm-4.1-adm1` feature `MEX.5_1`, bound on 2026-09-09 in commit 433a81a; the shipped geometry measures 73,075 km² in `data/final/polities_database.gpkg` (ESRI:54034 equal-area). Older text below that describes the polygon as missing predates that binding and is kept as the record of what blocked it.
