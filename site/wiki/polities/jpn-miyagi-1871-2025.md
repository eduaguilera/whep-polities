---
polity_code: JPN-MIYAGI-1871-2025
polity_name: Miyagi (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
Miyagi, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-MIYAGI` — **2,407 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.24_1` (Miyagi). GADM 4.1 admin-1
...
**Territory description.** Miyagi covers roughly **7,223 km2**, centred near
38.39°N 140.84°E, which places it on a modern map of Japan. For scale, that is
