---
polity_code: JPN-ISHIKAWA-1871-2025
polity_name: Ishikawa (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
Ishikawa, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-ISHIKAWA` — **2,370 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.15_1` (Ishikawa). GADM 4.1 admin-1
...
**Territory description.** Ishikawa covers roughly **4,236 km2**, centred near
37.13°N 136.98°E, which places it on a modern map of Japan. For scale, that is
