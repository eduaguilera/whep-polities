...
**Polygon status:** `assigned` — `gadm-4.1-adm1` feature `MEX.6_1`, bound on 2026-09-09 in commit 433a81a; the shipped geometry measures 247,405 km² in `data/final/polities_database.gpkg` (ESRI:54034 equal-area). Older text below that describes the polygon as missing predates that binding and is kept as the record of what blocked it.
...
**Territory description:** Modern Chihuahua state covers approximately 247,000 km2 (per INEGI, Mexico's national statistics institute) -- a reader can locate it on a current map as Mexico's largest state, occupying the north-central portion of the country against the US border, with its capital at Chihuahua City and its best-known landmark the Copper Canyon (Barrancas del Cobre) system in the Sierra Tarahumara. No area figure is given here as a measurement of any attached polygon, since none is attached to this entry yet; the 247,000 km2 figure is external (INEGI's present-day administrative area), not a polygon measurement. *(Superseded 2026-09-24: a polygon is now attached — `gadm-4.1-adm1` feature `MEX.6_1`, 247,405 km² as shipped; see the Polygon status line under Territorial extent.)*
...
**SUPERSEDED 2026-09-24.** The missing polygon recorded here no longer holds: `gadm-4.1-adm1` feature `MEX.6_1` was bound on 2026-09-09 in commit 433a81a, and the shipped geometry measures 247,405 km² in `data/final/polities_database.gpkg` (ESRI:54034 equal-area). The decision text is kept as the record of the state it described.
