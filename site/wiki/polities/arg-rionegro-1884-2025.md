...
**Polygon status:** `assigned` — `gadm-4.1-adm1` feature `ARG.16_1`, bound on 2026-09-09 in commit 433a81a; the shipped geometry measures 202,484 km² in `data/final/polities_database.gpkg` (ESRI:54034 equal-area). Older text below that describes the polygon as missing predates that binding and is kept as the record of what blocked it.
...
**RESOLVED 2026-09-24.** ARG-1884-1951 does not exist in the polity table. This page's frontmatter already tiles the span with the three live national rows instead: ARG-1800-1899 (1884-1899), ARG-1899-1902 (1899-1902) and ARG-1902-2025 (1902-2025).
