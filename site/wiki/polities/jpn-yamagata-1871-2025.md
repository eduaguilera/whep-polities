---
polity_code: JPN-YAMAGATA-1871-2025
polity_name: Yamagata (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
Yamagata, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-YAMAGATA` — **2,385 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.45_1` (Yamagata). GADM 4.1 admin-1
...
**Territory description.** Yamagata covers roughly **9,358 km2**, centred near
38.43°N 140.15°E, which places it on a modern map of Japan. For scale, that is
about 2.5% of Japan's land area, and the figure is a **measurement of
