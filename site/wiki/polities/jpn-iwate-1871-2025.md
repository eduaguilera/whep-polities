---
polity_code: JPN-IWATE-1871-2025
polity_name: Iwate (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
# Iwate (prefecture of Japan)

## Summary

Iwate, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-IWATE` — **2,334 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.16_1` (Iwate). GADM 4.1 admin-1
...
**Territory description.** Iwate covers roughly **15,235 km2**, centred near
39.60°N 141.37°E, which places it on a modern map of Japan. For scale, that is
about 4.0% of Japan's land area, and the figure is a **measurement of
