---
polity_code: JPN-YAMANASHI-1871-2025
polity_name: Yamanashi (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
Yamanashi, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-YAMANASHI` — **2,396 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.47_1` (Yamanashi). GADM 4.1 admin-1
...
**Territory description.** Yamanashi covers roughly **4,470 km2**, centred near
35.57°N 138.69°E, which places it on a modern map of Japan. For scale, that is
