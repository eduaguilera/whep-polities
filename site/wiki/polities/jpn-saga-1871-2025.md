---
polity_code: JPN-SAGA-1871-2025
polity_name: Saga (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
Saga, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-SAGA` — **2,413 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.34_1` (Saga). GADM 4.1 admin-1
...
**Territory description.** Saga covers roughly **2,455 km2**, centred near
33.25°N 130.10°E, which places it on a modern map of Japan. For scale, that is
