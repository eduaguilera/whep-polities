---
polity_code: JPN-YAMAGUCHI-1871-2025
polity_name: Yamaguchi (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
# Yamaguchi (prefecture of Japan)

## Summary

Yamaguchi, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-YAMAGUCHI` — **2,399 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.46_1` (Yamaguchi). GADM 4.1 admin-1
...
**Territory description.** Yamaguchi covers roughly **6,118 km2**, centred near
34.25°N 131.52°E, which places it on a modern map of Japan. For scale, that is
