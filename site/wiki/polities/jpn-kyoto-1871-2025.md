---
polity_code: JPN-KYOTO-1871-2025
polity_name: Kyoto (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
# Kyoto (prefecture of Japan)

## Summary

Kyoto, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-KYOTO` — **2,399 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.22_1` (Kyoto). GADM 4.1 admin-1
...
**Territory description.** Kyoto covers roughly **4,622 km2**, centred near
35.24°N 135.50°E, which places it on a modern map of Japan. For scale, that is
