---
polity_code: JPN-HOKKAIDO-1871-2025
polity_name: Hokkaido (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
Hokkaido, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-HOKKAIDO` — **2,251 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.12_1` (Hokkaido). GADM 4.1 admin-1
...
**Territory description.** Hokkaido covers roughly **78,058 km2**, centred near
43.46°N 143.33°E, which places it on a modern map of Japan. For scale, that is
about 20.7% of Japan's land area, and the figure is a **measurement of
