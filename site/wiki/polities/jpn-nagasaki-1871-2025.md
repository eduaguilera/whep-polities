---
polity_code: JPN-NAGASAKI-1871-2025
polity_name: Nagasaki (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
Nagasaki, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-NAGASAKI` — **2,435 valued rows**,
...
**Name note.** The panel spells this unit `Nagasaki` and GADM 4.1 spells it `Naoasaki`. GADM's spelling is a defect, not a variant.

## Territorial extent

**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.27_1` (Naoasaki). GADM 4.1 admin-1
...
**Territory description.** Nagasaki covers roughly **4,204 km2**, centred near
32.69°N 128.76°E, which places it on a modern map of Japan. For scale, that is
about 1.1% of Japan's land area, and the figure is a **measurement of
