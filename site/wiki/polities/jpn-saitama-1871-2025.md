---
polity_code: JPN-SAITAMA-1871-2025
polity_name: Saitama (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
# Saitama (prefecture of Japan)

## Summary

Saitama, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-SAITAMA` — **2,396 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.35_1` (Saitama). GADM 4.1 admin-1
...
**Territory description.** Saitama covers roughly **3,795 km2**, centred near
36.02°N 139.29°E, which places it on a modern map of Japan. For scale, that is
about 1.0% of Japan's land area, and the figure is a **measurement of
