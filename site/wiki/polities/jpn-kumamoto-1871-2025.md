---
polity_code: JPN-KUMAMOTO-1871-2025
polity_name: Kumamoto (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
# Kumamoto (prefecture of Japan)

## Summary

Kumamoto, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-KUMAMOTO` — **2,453 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.21_1` (Kumamoto). GADM 4.1 admin-1
...
**Territory description.** Kumamoto covers roughly **7,564 km2**, centred near
32.64°N 130.80°E, which places it on a modern map of Japan. For scale, that is
about 2.0% of Japan's land area, and the figure is a **measurement of
