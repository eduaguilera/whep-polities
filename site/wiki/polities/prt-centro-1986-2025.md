...
**Polygon status:** `assigned` — `eurostat-gisco-nuts2` feature `PT16`, bound on 2026-09-11 in commit 1905710; the shipped geometry measures 28,191 km² in `data/final/polities_database.gpkg` (ESRI:54034 equal-area). Older text below that describes the polygon as missing predates that binding and is kept as the record of what blocked it.
