---
polity_code: JPN-KAGAWA-1871-2025
polity_name: Kagawa (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
Kagawa, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-KAGAWA` — **2,310 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.17_1` (Kagawa). GADM 4.1 admin-1
...
**Territory description.** Kagawa covers roughly **1,727 km2**, centred near
34.21°N 134.04°E, which places it on a modern map of Japan. For scale, that is
about 0.5% of Japan's land area, and the figure is a **measurement of
