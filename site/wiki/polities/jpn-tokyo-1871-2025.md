---
polity_code: JPN-TOKYO-1871-2025
polity_name: Tokyo (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
# Tokyo (prefecture of Japan)

## Summary

Tokyo, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-TOKYO` — **2,366 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.41_1` (Tokyo). GADM 4.1 admin-1
...
**Territory description.** Tokyo covers roughly **2,167 km2**, centred near
35.70°N 139.46°E, which places it on a modern map of Japan. For scale, that is
