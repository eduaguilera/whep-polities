---
polity_code: JPN-MIE-1871-2025
polity_name: Mie (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
Mie, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-MIE` — **2,410 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.23_1` (Mie). GADM 4.1 admin-1
...
**Territory description.** Mie covers roughly **5,777 km2**, centred near
34.49°N 136.52°E, which places it on a modern map of Japan. For scale, that is
