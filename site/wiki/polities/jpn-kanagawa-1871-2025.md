---
polity_code: JPN-KANAGAWA-1871-2025
polity_name: Kanagawa (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
# Kanagawa (prefecture of Japan)

## Summary

Kanagawa, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-KANAGAWA` — **2,357 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.19_1` (Kanagawa). GADM 4.1 admin-1
...
**Territory description.** Kanagawa covers roughly **2,384 km2**, centred near
35.40°N 139.28°E, which places it on a modern map of Japan. For scale, that is
about 0.6% of Japan's land area, and the figure is a **measurement of
