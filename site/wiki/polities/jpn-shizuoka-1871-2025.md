---
polity_code: JPN-SHIZUOKA-1871-2025
polity_name: Shizuoka (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
Shizuoka, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-SHIZUOKA` — **2,432 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.38_1` (Shizuoka). GADM 4.1 admin-1
...
**Territory description.** Shizuoka covers roughly **7,640 km2**, centred near
35.12°N 138.22°E, which places it on a modern map of Japan. For scale, that is
