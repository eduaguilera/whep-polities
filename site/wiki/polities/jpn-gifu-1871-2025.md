---
polity_code: JPN-GIFU-1871-2025
polity_name: Gifu (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
# Gifu (prefecture of Japan)

## Summary

Gifu, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-GIFU` — **2,384 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.9_1` (Gifu). GADM 4.1 admin-1
...
**Territory description.** Gifu covers roughly **10,604 km2**, centred near
35.80°N 137.07°E, which places it on a modern map of Japan. For scale, that is
about 2.8% of Japan's land area, and the figure is a **measurement of
