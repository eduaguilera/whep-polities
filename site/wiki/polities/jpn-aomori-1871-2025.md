---
polity_code: JPN-AOMORI-1871-2025
polity_name: Aomori (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
# Aomori (prefecture of Japan)

## Summary

Aomori, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-AOMORI` — **2,240 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.3_1` (Aomori). GADM 4.1 admin-1
...
**Territory description.** Aomori covers roughly **9,670 km2**, centred near
40.88°N 140.49°E, which places it on a modern map of Japan. For scale, that is
about 2.6% of Japan's land area, and the figure is a **measurement of
