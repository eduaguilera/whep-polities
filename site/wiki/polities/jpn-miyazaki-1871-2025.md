---
polity_code: JPN-MIYAZAKI-1871-2025
polity_name: Miyazaki (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
# Miyazaki (prefecture of Japan)

## Summary

Miyazaki, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-MIYAZAKI` — **2,423 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.25_1` (Miyazaki). GADM 4.1 admin-1
...
**Territory description.** Miyazaki covers roughly **7,679 km2**, centred near
32.10°N 131.19°E, which places it on a modern map of Japan. For scale, that is
