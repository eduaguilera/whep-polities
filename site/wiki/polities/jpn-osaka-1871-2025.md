---
polity_code: JPN-OSAKA-1871-2025
polity_name: Osaka (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
Osaka, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-OSAKA` — **2,175 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.33_1` (Osaka). GADM 4.1 admin-1
...
**Territory description.** Osaka covers roughly **1,913 km2**, centred near
34.66°N 135.55°E, which places it on a modern map of Japan. For scale, that is
