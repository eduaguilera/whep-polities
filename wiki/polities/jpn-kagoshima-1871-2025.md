---
polity_code: JPN-KAGOSHIMA-1871-2025
polity_name: Kagoshima (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
# Kagoshima (prefecture of Japan)

## Summary

Kagoshima, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-KAGOSHIMA` — **2,440 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.18_1` (Kagoshima). GADM 4.1 admin-1
...
**Territory description.** Kagoshima covers roughly **9,133 km2**, centred near
31.59°N 130.99°E, which places it on a modern map of Japan. For scale, that is
about 2.4% of Japan's land area, and the figure is a **measurement of
