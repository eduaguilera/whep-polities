---
polity_code: JPN-NARA-1871-2025
polity_name: Nara (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
Nara, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-NARA` — **2,252 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.28_1` (Nara). GADM 4.1 admin-1
...
**Territory description.** Nara covers roughly **3,683 km2**, centred near
34.32°N 135.89°E, which places it on a modern map of Japan. For scale, that is
