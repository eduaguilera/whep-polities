---
polity_code: JPN-FUKUI-1871-2025
polity_name: Fukui (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
# Fukui (prefecture of Japan)

## Summary

Fukui, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-FUKUI` — **2,361 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.6_1` (Fukui). GADM 4.1 admin-1
...
**Territory description.** Fukui covers roughly **4,235 km2**, centred near
35.82°N 136.44°E, which places it on a modern map of Japan. For scale, that is
