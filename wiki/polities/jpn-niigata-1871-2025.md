---
polity_code: JPN-NIIGATA-1871-2025
polity_name: Niigata (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
Niigata, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-NIIGATA` — **2,357 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.29_1` (Niigata). GADM 4.1 admin-1
...
**Territory description.** Niigata covers roughly **12,688 km2**, centred near
37.64°N 139.16°E, which places it on a modern map of Japan. For scale, that is
about 3.4% of Japan's land area, and the figure is a **measurement of
