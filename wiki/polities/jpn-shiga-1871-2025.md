---
polity_code: JPN-SHIGA-1871-2025
polity_name: Shiga (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
# Shiga (prefecture of Japan)

## Summary

Shiga, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-SHIGA` — **2,399 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.36_1` (Shiga). GADM 4.1 admin-1
...
**Territory description.** Shiga covers roughly **4,017 km2**, centred near
35.24°N 136.11°E, which places it on a modern map of Japan. For scale, that is
