---
polity_code: JPN-TOKUSHIMA-1871-2025
polity_name: Tokushima (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
Tokushima, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-TOKUSHIMA` — **2,425 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.40_1` (Tokushima). GADM 4.1 admin-1
...
**Territory description.** Tokushima covers roughly **4,128 km2**, centred near
33.89°N 134.18°E, which places it on a modern map of Japan. For scale, that is
