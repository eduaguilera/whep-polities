---
polity_code: JPN-FUKUOKA-1871-2025
polity_name: Fukuoka (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
Fukuoka, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-FUKUOKA` — **2,399 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.7_1` (Fukuoka). GADM 4.1 admin-1
...
**Territory description.** Fukuoka covers roughly **5,009 km2**, centred near
33.48°N 130.50°E, which places it on a modern map of Japan. For scale, that is
about 1.3% of Japan's land area, and the figure is a **measurement of
