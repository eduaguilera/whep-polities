---
polity_code: JPN-NAGANO-1871-2025
polity_name: Nagano (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
Nagano, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-NAGANO` — **2,413 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.26_1` (Nagano). GADM 4.1 admin-1
...
**Territory description.** Nagano covers roughly **13,580 km2**, centred near
36.11°N 138.10°E, which places it on a modern map of Japan. For scale, that is
