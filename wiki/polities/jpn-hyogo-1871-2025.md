---
polity_code: JPN-HYOGO-1871-2025
polity_name: Hyogo (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
Hyogo, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-HYOGO` — **2,399 valued rows**,
...
**Name note.** The panel spells this unit `Hyogo` and GADM 4.1 spells it `Hyōgo`. Both refer to the same unit.

## Territorial extent

**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.13_1` (Hyōgo). GADM 4.1 admin-1
...
**Territory description.** Hyogo covers roughly **8,382 km2**, centred near
35.15°N 134.85°E, which places it on a modern map of Japan. For scale, that is
