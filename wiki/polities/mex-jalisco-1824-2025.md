...
**Polygon status:** `assigned` — `gadm-4.1-adm1` feature `MEX.14_1`, bound on 2026-09-09 in commit 433a81a; the shipped geometry measures 78,607 km² in `data/final/polities_database.gpkg` (ESRI:54034 equal-area). Older text below that describes the polygon as missing predates that binding and is kept as the record of what blocked it.
...
**Update 2026-09-24.** The polygon this question anticipated is now attached (`gadm-4.1-adm1` feature `MEX.14_1`, bound on 2026-09-09 in commit 433a81a; 78,607 km² as shipped). The rest of the question is unaffected and stays open.
