---
polity_code: JPN-CHIBA-1871-2025
polity_name: Chiba (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
Chiba, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-CHIBA` — **2,436 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.4_1` (Chiba). GADM 4.1 admin-1
...
**Territory description.** Chiba covers roughly **5,044 km2**, centred near
35.50°N 140.23°E, which places it on a modern map of Japan. For scale, that is
