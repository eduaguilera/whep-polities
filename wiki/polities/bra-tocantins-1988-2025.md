...
**Polygon status:** `assigned` — `geobr-ibge` feature `TO` (feature year 2020), bound on 2026-09-09 in commit 00f8e72; the shipped geometry measures 277,441 km² in `data/final/polities_database.gpkg` (ESRI:54034 equal-area). Older text below that describes the polygon as missing predates that binding and is kept as the record of what blocked it.
