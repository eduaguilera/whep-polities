---
polity_code: JPN-FUKUSHIMA-1871-2025
polity_name: Fukushima (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
Fukushima, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-FUKUSHIMA` — **2,407 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.8_1` (Fukushima). GADM 4.1 admin-1
...
**Territory description.** Fukushima covers roughly **13,738 km2**, centred near
37.38°N 140.14°E, which places it on a modern map of Japan. For scale, that is
about 3.6% of Japan's land area, and the figure is a **measurement of
