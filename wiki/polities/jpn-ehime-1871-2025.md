---
polity_code: JPN-EHIME-1871-2025
polity_name: Ehime (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
# Ehime (prefecture of Japan)

## Summary

Ehime, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-EHIME` — **2,300 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.5_1` (Ehime). GADM 4.1 admin-1
...
**Territory description.** Ehime covers roughly **5,749 km2**, centred near
33.52°N 132.71°E, which places it on a modern map of Japan. For scale, that is
about 1.5% of Japan's land area, and the figure is a **measurement of
