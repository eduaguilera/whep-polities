---
polity_code: JPN-AKITA-1871-2025
polity_name: Akita (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
Akita, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-AKITA` — **2,348 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.2_1` (Akita). GADM 4.1 admin-1
...
**Territory description.** Akita covers roughly **11,644 km2**, centred near
39.69°N 140.44°E, which places it on a modern map of Japan. For scale, that is
about 3.1% of Japan's land area, and the figure is a **measurement of
