---
polity_code: JPN-KOCHI-1871-2025
polity_name: Kochi (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
# Kochi (prefecture of Japan)

## Summary

Kochi, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-KOCHI` — **2,318 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.20_1` (Kochi). GADM 4.1 admin-1
...
**Territory description.** Kochi covers roughly **7,043 km2**, centred near
33.30°N 133.06°E, which places it on a modern map of Japan. For scale, that is
