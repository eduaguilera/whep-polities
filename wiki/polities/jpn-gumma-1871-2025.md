---
polity_code: JPN-GUMMA-1871-2025
polity_name: Gumma (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
Gumma, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-GUMMA` — **2,399 valued rows**,
...
**Name note.** The panel spells this unit `Gumma` and GADM 4.1 spells it `Gunma`. GADM's spelling is a defect, not a variant.

## Territorial extent

**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.10_1` (Gunma). GADM 4.1 admin-1
...
**Territory description.** Gumma covers roughly **6,369 km2**, centred near
36.52°N 138.92°E, which places it on a modern map of Japan. For scale, that is
