---
polity_code: JPN-SHIMANE-1871-2025
polity_name: Shimane (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
Shimane, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-SHIMANE` — **2,399 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.37_1` (Shimane). GADM 4.1 admin-1
...
**Territory description.** Shimane covers roughly **6,692 km2**, centred near
34.95°N 132.43°E, which places it on a modern map of Japan. For scale, that is
about 1.8% of Japan's land area, and the figure is a **measurement of
