---
polity_code: JPN-TOCHIGI-1871-2025
polity_name: Tochigi (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
# Tochigi (prefecture of Japan)

## Summary

Tochigi, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-TOCHIGI` — **2,399 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.39_1` (Tochigi). GADM 4.1 admin-1
...
**Territory description.** Tochigi covers roughly **6,403 km2**, centred near
36.68°N 139.78°E, which places it on a modern map of Japan. For scale, that is
about 1.7% of Japan's land area, and the figure is a **measurement of
