...
polity_name: Aichi (prefecture of Japan)
start_year: 1871
end_year: 2025
type: subnational
iso3: JPN
...
Aichi, a prefecture of Japan. This is a **subnational reporting unit, not a
...
prefecture figures for this unit as `JPN-AICHI` — **2,408 valued rows**,
...
**Polygon status:** assigned from `gadm-4.1-adm1` feature `JPN.1_1` (Aichi). GADM 4.1 admin-1
...
**Territory description.** Aichi covers roughly **5,153 km2**, centred near
35.00°N 137.28°E, which places it on a modern map of Japan. For scale, that is
about 1.4% of Japan's land area, and the figure is a **measurement of
