...
| Metric | Value |
|---|---|
| Polities in the database | 775 |
| Polity pages | 775 |
| Sources ingested | 30 |
| `status: draft` | 672 |
| `status: reviewed` | 59 |
| `status: superseded` / `retired` | 21 / 23 |
| Pages with no source citation | 209 |
| Pages citing biger-1995 | 398 |
| Open questions (`### oq-`) | 832 |

**By continent:** Africa 274 · Europe 175 · Asia 163 · North America 69 · Oceania 46 · South America 45 · World 2
