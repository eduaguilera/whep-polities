...
ggsave(
  file.path(plot_dir, "13_whep_world_coverage.png"),
  p_map1,
  width = 16,
  height = 9,
  dpi = 150
...
ggsave(
  file.path(plot_dir, "14_earliest_coverage_map.png"),
  p_map2,
  width = 16,
  height = 9,
  dpi = 150
...
ggsave(
  file.path(plot_dir, "15_territorial_complexity_map.png"),
  p_map3,
  width = 16,
  height = 9,
  dpi = 150
...
ggsave(
  file.path(plot_dir, "16_empire_affiliation_map.png"),
  p_map4,
  width = 16,
  height = 9,
  dpi = 150
...
ggsave(
  file.path(plot_dir, "17_continent_type_distribution.png"),
  p_cont_type,
  width = 12,
  height = 7,
  dpi = 150
